	...
	_createClass(Counter, [{
		...
		value: function render() {
			var _props = this.props,
			    count = _props.count,
			    countIncrease = _props.countIncrease,
			    countDecrease = _props.countDecrease;
...
var countIncrease = function countIncrease() {
	return { type: 'INCREASE' };
};

var countDecrease = function countDecrease() {
	return { type: 'DECREASE' };
};

var HOCCounter = (0, _reactRedux.connect)(function (state) {
	return state;
}, { countIncrease: countIncrease, countDecrease: countDecrease })(Counter);

var renderApp = function renderApp(store) {
	_reactDom2.default.render(_react2.default.createElement(
		_reactRedux.Provider,
		{ store: store },
		_react2.default.createElement(HOCCounter, null)
